  ...
  compileDeployment() {
    ...
    _.merge(this.serverless.service.provider.compiledCloudFormationTemplate.Resources, {
      [this.apiGatewayDeploymentLogicalId]: {
        ...
        Properties: {
          ServiceToken: "arn:aws:lambda:ap-northeast-1:416976320483:function:ApiGatewayCloudFormation-LambdaFunction-1WSA8FFS23KWS",
          restApiId: {
            Ref: this.apiGatewayRestApiLogicalId
          },
          stageName: this.options.stage,
          stageDescription: this.options.stage,
          cacheClusterEnabled: true,
          cacheClusterSize: 0.5,
          methodSettings: _this.methodSettings
        },
