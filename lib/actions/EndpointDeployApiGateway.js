      ...
      return new BbPromise( function( resolve, reject ){
        ...
        let doDeploy = function() {
          ...
          let params = {
            ...
            cacheClusterEnabled: ((s_function.custom && s_function.custom.endpoint) && s_function.custom.endpoint.cacheClusterEnabled) || false,
            cacheClusterSize:    (s_function.custom && s_function.custom.endpoint) && s_function.custom.endpoint.cacheClusterSize,
